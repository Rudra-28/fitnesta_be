...
router.get("/batches/all", trainerGuard, controller.getTrainerBatches);                    // GET /api/v1/trainer-dashboard/batches/all                        // GET   /api/v1/trainer-dashboard/batches

router.get("/wallet", trainerGuard, controller.getWalletSummary);                             // GET /api/v1/trainer-dashboard/wallet
router.get("/wallet/:status", trainerGuard, controller.getWalletBreakdown);                  // GET /api/v1/trainer-dashboard/wallet/pending|approved|paid
